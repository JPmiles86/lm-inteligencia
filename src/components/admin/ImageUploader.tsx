...
import { Upload, X, AlertCircle, CheckCircle, Wifi, WifiOff } from 'lucide-react';
import imageUploadService, { UploadedImage, UploadProgress } from '../../services/imageUploadService.js';

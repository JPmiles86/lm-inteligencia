// Social Media Content - Extracted from SocialMediaModal
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="text-center">
        <div className="w-16 h-16 mx-auto mb-4 bg-pink-100 dark:bg-pink-900/20 rounded-full flex items-center justify-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          Content will be migrated from SocialMediaModal.tsx
        </p>

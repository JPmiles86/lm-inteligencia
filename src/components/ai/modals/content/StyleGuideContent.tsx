...
import {
  Plus, Edit3, Trash2, Save, Search, Check, Loader2,
...
export const StyleGuideContent: React.FC<StyleGuideContentProps> = ({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {/* Tabs */}
      <div className={`flex-shrink-0 flex items-center space-x-1 ${isMobile ? 'p-4 pb-2' : 'p-4 pt-6 pb-4'} border-b border-gray-200 dark:border-gray-700 overflow-x-auto`}>
        {(['brand', 'vertical', 'writing', 'persona'] as const).map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex items-center space-x-2 px-3 md:px-4 py-2 border-b-2 transition-colors flex-shrink-0 min-h-[44px] ${
                activeTab === tab
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Panel - List */}
        <div className={`${isMobile ? 'w-full border-b' : 'w-1/3 border-r'} border-gray-200 dark:border-gray-700 overflow-y-auto flex-shrink-0`}>
          {/* Search Bar */}
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-base min-h-[44px]"
              />
            </div>
          </div>
                ...
                {getFilteredGuides().length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors inline-flex items-center space-x-2 min-h-[44px]"
                    >
                  ...
                  <>
                    <button
                      onClick={() => setShowCreateForm(true)}
                      className="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors inline-flex items-center justify-center space-x-2 mb-4 min-h-[44px]"
                    >
                      <Plus className="h-4 w-4" />
                      <span>New Guide</span>
                    </button>
                      ...
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <button
                            ...
                            className="ml-2 flex-shrink-0 min-h-[44px] min-w-[44px] flex items-center justify-center"
                          >
                            {guide.active ? (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-base min-h-[44px]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white h-24 text-base"
                    />
                  ...
                  <div className="flex justify-end space-x-3 pt-4">
                    <button
                      ...
                      className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors min-h-[44px]"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors inline-flex items-center space-x-2 min-h-[44px]"
                    >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white h-32 text-base"
                    />
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  ...
                  <div className="flex justify-end space-x-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:opacity-50 transition-colors inline-flex items-center space-x-2 min-h-[44px]"
                    >
                      {aiGenerating ? (
                        <Loader2 className="h-4 w-4 animate-spin" />
                      ) : (
                    ...
                    {!isEditing && (
                      <>
                        <button
                          ...
                          className="p-2 hover:bg-purple-100 dark:hover:bg-purple-900/30 rounded-lg transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"

...
export const universalContent: UniversalContent & {
  ...
  about: {
    ...
    founderStory: {
      ...
      description: '<a href="https://www.linkedin.com/in/laurie-meiring/" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-800 underline">Laurie Meiring</a> brings over a decade of digital marketing leadership to Inteligencia, backed by an MBA and a career spanning hospitality, healthcare, technology, and sports/media. He has a proven ability to connect with audiences and generate demand through digital marketing tactics tailored to each client.',
